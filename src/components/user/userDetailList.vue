...
<div>
    <div class="search-box">
       ...
       <span >会员名：</span><el-input v-model="name" class="search-ipt" placeholder="请输入内容"></el-input>
  ...
  <el-table
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="handleEdit(5,scope.row)">详细</el-button>
