...
<div>
    <div class="search-box">
      <span></span><el-input  v-model="barcode" class="search-ipt" placeholder="条形码"></el-input>
      <span></span><el-input  v-model="name" class="search-ipt" placeholder="商品名称"></el-input>
      <span></span><el-input  v-model="firstLetter" class="search-ipt" placeholder="拼音首字母缩写"></el-input>
...
<script>
import addDialog from "./stockAddList.vue";
...
export default {
  ...
  data() {
    return {
      url: this.common.serverUrl + "/produc/queryShopProductPage",
      name: "",
      price:0,
      productNum:0,
      state:"",
  ...
  methods: {
    ...
    sureAdd(form) {
      ...
      params.name=form.brand;
      this.common
        .httpPost("/produc/addShopProduct", params, "")
        .then(res => {
