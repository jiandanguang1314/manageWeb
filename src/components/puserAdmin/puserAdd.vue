    ...
    <el-dialog :visible.sync="showValue" :title="dialogType" :before-close="closeDialog" @open="open()" style="min-width:980px;">
      <el-form :model="dataForm" :rules="rules" ref="rulesForm">
        <el-form-item label="手机号：" prop="mobile" :label-width="formLabelWidth">
          <el-col :span="22">
            <el-input v-model="dataForm.mobile" auto-complete="off" :maxlength="11">
            </el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="用户名：" prop="userName" :label-width="formLabelWidth">
          <el-col :span="22">
            <el-input v-model="dataForm.userName" auto-complete="off" :maxlength="20">
            </el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="角色类型" prop="userType" :label-width="formLabelWidth">
          <el-col :span="22">
            <div>
              <el-select v-model="dataForm.userType" @change="getRoleData" clearable style="width: 100%" placeholder="请选择">
        ...
        <el-form-item label="所属角色" prop="roleIds" :label-width="formLabelWidth">
          <el-col :span="22">
            <div>
              <el-select v-model="dataForm.roleIds" clearable style="width: 100%" placeholder="请选择">
                <el-option v-for="(item,index) in roledatas" :key="index" :label="item.roleName" :value="item.id">
                </el-option>
              </el-select>
            </div>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    getRoleData(val) {
      this.roledatas = [];
      let url =
        this.common.serverUrl +
        "/system/getRoleInfoByType?" +
        "roleType=" +
        val;
